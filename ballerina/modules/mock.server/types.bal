...
# Association response with multiple labeled objects and pagination support
...
# Detailed error information including context and remediation guidance
...
# Request object for creating multiple associations between two objects
...
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of successfully processed association labels between object pairs
...
# Request payload for archiving multiple associations from one object
...
# Default association definition between two HubSpot objects
...
# Response containing multiple associated objects with their labels
...
# Batch request payload for creating multiple associations
...
# Request payload for creating a default association between objects
...
# Request object containing multiple association fetch operations for batch processing
public type BatchInputPublicFetchAssociationsBatchRequest record {
    # Array of individual association fetch requests to be processed in the batch
    PublicFetchAssociationsBatchRequest[] inputs;
};

# Response object for batch association operations with labeled associations and processing metadata
...
# Response object for batch operations with no return data, containing only processing status
public type BatchResponseVoid record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of void results from successful batch operations
    anydata[] results;
    # Array of errors encountered during batch processing
    StandardError[] errors?;
    # The status of the batch processing request: "PENDING", "PROCESSING", "CANCELED", or "COMPLETE"
...
# Request object for fetching associations of a specific object with pagination support
