...
# Request to create multiple associations between objects
...
# Batch response containing labels between object pairs with status
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of successful label results between object pairs
...
public type PublicAssociationMultiArchive record {
    # Contains the Id of a Public Object
    PublicObjectId 'from;
    # Array of target object identifiers for associations to be archived
    PublicObjectId[] to;
};
...
# Schema for creating default associations between objects
...
# Batch request container for fetching multiple object associations
...
# Batch response containing association results with labels and processing metadata
...
# Batch response for operations with no return data, containing processing status
public type BatchResponseVoid record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Empty results array for operations that don't return data
    anydata[] results;
...
# Request to fetch associations for a specific object with optional pagination
