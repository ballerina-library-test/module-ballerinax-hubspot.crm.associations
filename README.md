...
2. Ensure you have access to private apps functionality. This feature is available on all HubSpot subscription tiers, including the free tier.

### Step 2: Generate an API Access Token

1. Log in to your HubSpot account.

2. In your HubSpot account, navigate to Settings (the gear icon) in the main navigation bar.
...
9. Copy the generated access token from the app details page.
